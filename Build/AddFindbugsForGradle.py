...
# list中向上插入元素
#query_string是replace_before[1],replace_string是指replace_after[0]
...
if __name__ == '__main__':
    # get file content
    FINDBUGS = 'addReleaseForGradle/Findbugs.txt'
    #获取findbugs.txt文件内容
    FINDBUGS_LIST = getFileContent(FINDBUGS)
    ...
    #获取dependencies中内容
    DEPENDENCIES = REPLACE_BEFORE_LIST[3]
    ...
    insertSingingConfigs(GRADLEFILE_PATH, DEPENDENCIES, FINDBUGS_LIST)
