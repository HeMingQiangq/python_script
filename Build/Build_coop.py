...
def ChangeDebugChoices():
    """根据参数，修改debugtool中展示的选项"""
    if IS_SHAKE == "true":
        if len(DEBUGTOOL_CHOICES) != 0:
            list1 = Util.stringToList(DEBUGTOOL_CHOICES)
            Util.ChooseFileContentDebugTool(Const.PATH_DebugTool_View,DEBUGTOOL_CHOICES)
