...
def __init__(self):
        ...
        self.build_status = findbugs.Build_Ststus
        self.build_url = findbugs.Build_Url
        self.project_url = findbugs.Projec_tUrl
        self.workspace = findbugs.Workspace
        self.message ="构建状态："+self.build_status +"\r"+"goujiandizhi:"+self.build_url
        self.code_status = findbugs.findbugreport
...
def send_email(code_status,build_status,build_url):
        ...
        project_url = findbugs.Projec_tUrl
        workspace = findbugs.Workspace
        ...
        msg = MIMEText(code_status+"\r"+"\r"+messagee,'html','utf-8')
