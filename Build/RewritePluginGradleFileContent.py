...
if __name__ == '__main__':
    ...
    GRADLEFILE_PATH = WORKSPACE + '/app_im/build.gradle'

    BUILDTYPES = REPLACE_BEFORE_LIST[0]
    MINIFYENABLED = REPLACE_BEFORE_LIST[4]

    SIGNCONFIGS_RELEASE = REPLACE_AFTER_LIST[0]
    ZIPALIGNENABLED = REPLACE_AFTER_LIST[1]

    insertSingingConfigs(GRADLEFILE_PATH, BUILDTYPES, SIGNING_CONFIGS_LIST)
    insertSingingConfigs(GRADLEFILE_PATH, MINIFYENABLED, SIGNCONFIGS_RELEASE)
